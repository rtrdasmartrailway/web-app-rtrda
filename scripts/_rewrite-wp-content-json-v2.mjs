...
for (const rec of json.records) {
  ...
  rec.contentHtml = rec.contentHtml
    ...
    .replace(/src="\/en\/wp-content\/uploads\//g, () => {
      count.srcEN++;
      return `src="${LEGACY}/wp-content/uploads/`;
    })
    ...
    .replace(/href="\/en\/wp-content\/uploads\//g, () => {
      count.hrefEN++;
      return `href="${LEGACY}/wp-content/uploads/`;
    })
    .replace(/href="\/en\/3d-flip-book\//g, () => {
      count.hrefEN++;
      return `href="${LEGACY}/3d-flip-book/`;
    })
    .replace(/href="\/en\/sdc_download\//g, () => {
      count.hrefEN++;
      return `href="${LEGACY}/sdc_download/`;
    });
