  ...
  it("rewrites the real th-page-4837 JSON: 2569 section changes, 2568 section is intact", async () => {
    ...
    expect(linksFor("O8")).toEqual([
      {
        ...
        href: "/wp-content/uploads/ita2569/O8/o8-01-คู่มือการปฏิบัติงาน-การรับ-ส่งหนังสือที่เ.pdf",
      },
      {
        title: "– คู่มือ การจัดการเรื่องร้องเรียนการทุจริตและประพฤติมิชอบ",
        href: "/wp-content/uploads/ita2569/O8/o8-02-คู่มือ-การจัดการเรื่องร้องเรียนการทุจริตและประพฤติมิชอบ.pdf",
      },
      {
        title: "– คู่มือ การจัดการเรื่องร้องเรียนแจ้งเบาะแส",
        href: "/wp-content/uploads/ita2569/O8/o8-03-คู่มือ-การจัดการเรื่องร้องเรียนแจ้งเบาะแส.pdf",
      },
      {
        title: "– คู่มือการปฏิบัติงานศูนย์ข้อมูลข่าวสาร สทร. (ฉบับปรับปรุง พ.ศ. 2569)",
        href: "/wp-content/uploads/ita2569/O8/o8-04-คู่มือการปฏิบัติงานศูนย์ข้อมูลข่าวสาร-สทร.-ฉบับปรับปรุง-พ.ศ.-2569.pdf",
      },
    ]);
    ...
    expect(linksFor("O13")).toEqual([
      ...
      },
      {
        ...
        href: "/wp-content/uploads/ita2569/O13/o13_2_หลักเกณฑ์การเข้าสู่ตำแหน่ง_ปรับระดับตำแหน่ง.pdf",
      },
      {
        title: "– หลักเกณฑ์และวิธีการประเมินผลการปฏิบัติงาน",
        href: "/wp-content/uploads/ita2569/O13/o13_3_หลักเกณฑ์และวิธีการประเมินผลการปฏิบัติงาน.pdf",
      },
      {
        title: "– หลักเกณฑ์การปรับวุฒิและปรับอัตราค่าจ้างตามคุณวุฒิ",
        href: "/wp-content/uploads/ita2569/O13/o13_4_หลักเกณฑ์การปรับวุฒิและปรับอัตราค่าจ้างตามคุณวุฒิ.pdf",
      },
      {
