...
const summaryRows: TableRowSpec[] = [
  {
    ...
    href: uploadFile("2026/09/procurement-summary-august-2569-20260902.pdf"),
  },
  {
...
const winnerRows: TableRowSpec[] = [
  {
    ...
    cells: [
      "1 พฤษภาคม 2569",
      "ประกาศผู้ชนะการเสนอราคา โครงการปรับปรุงตู้รถไฟโดยสาร: ตู้รถไฟโดยสารนั่งและนอนชั้นหนึ่งปรับอากาศ และตู้รถไฟโดยสารชั้นสองปรับอากาศ (Passenger Coach Refurbishment) โดยวิธีคัดเลือก",
      "40,433,706.00",
      "–",
    ],
    href: uploadFile(
  ...
  {
    matchText:
      "โครงการยกระดับขีดความสามารถของระบบฐานข้อมูลของสถาบันฯ เพื่อเป็นระบบฐานข้อมูลกลางของประเทศ",
    cells: [
      "1 กันยายน 2569",
      "โครงการยกระดับขีดความสามารถของระบบฐานข้อมูลของสถาบันฯ เพื่อเป็นระบบฐานข้อมูลกลางของประเทศ โดยวิธีเฉพาะเจาะจง",
      "430,000.00",
      "–",
    ],
    href: uploadFile("2026/09/procurement-winner-database-capability-25690901.pdf"),
  },
  {
    matchText: "จ้างเหมาบริการจัดพิมพ์รูปเล่มมาตรฐาน และแผ่นพับประชาสัมพันธ์",
    cells: [
      "28 สิงหาคม 2569",
      "ประกาศผู้ชนะการเสนอราคา จ้างเหมาบริการจัดพิมพ์รูปเล่มมาตรฐาน และแผ่นพับประชาสัมพันธ์ ของสถาบันวิจัยและพัฒนาเทคโนโลยีระบบราง (องค์การมหาชน) โดยวิธีเฉพาะเจาะจง",
      "208,594.00",
      "–",
    ],
    href: uploadFile("2026/08/procurement-winner-standard-publication-25690828.pdf"),
  },
  {
    matchText: "งานจ้างที่ปรึกษาโครงการส่งเสริมการแข่งขัน",
    cells: [
      "19 สิงหาคม 2569",
      "ประกาศผู้ชนะการเสนอราคา งานจ้างที่ปรึกษาโครงการส่งเสริมการแข่งขัน และส่งเสริมสภาพแวดล้อมระบบรางเพื่อส่งเสริมการใช้งานระบบราง โดยวิธีจ้างที่ปรึกษาโดยวิธีเฉพาะเจาะจง",
      "900,000.00",
      "–",
    ],
    href: uploadFile(
      "2026/08/procurement-winner-rail-competition-consultant-25690819.pdf",
    ),
  },
  {
    matchText: "จัดจ้างโครงการพัฒนาตู้รถไฟท่องเที่ยวต้นแบบ (Siamese Train)",
    cells: [
      "21 กรกฎาคม 2569",
      "ประกาศผู้ชนะการเสนอราคา จัดจ้างโครงการพัฒนาตู้รถไฟท่องเที่ยวต้นแบบ (Siamese Train) โดยวิธีคัดเลือก",
      "21,000,000.00",
      "–",
    ],
    href: uploadFile(
      "2026/07/ประกาศผู้ชนะโครงการพัฒนาตู้รถไฟท่องเที่ยว_21_07_2569.pdf?v=20260721",
    ),
  },
  {
